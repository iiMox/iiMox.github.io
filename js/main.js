...
$(".slider .slider-content").height(
    $(window).height() - (myHeaderHeight + $(".slider hr").outerHeight())
);
...
$(".slider .slider-content .container").css({
    "padding-top":
        (mySliderHeight -
            $(".slider .slider-content .container").innerHeight()) /
        2,
});
...
$(".gallery .works .work").each(function () {
    let myWork = $(this);
